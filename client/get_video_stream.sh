...
# Get the video stream and save it to the specified file for 5 seconds using GStreamer
start_time=$(date +%s)
gst-launch-1.0 rtmpsrc location="rtmp://10.0.0.1:1935/live/video.flv" ! flvdemux ! decodebin ! videoconvert ! x264enc ! flvmux ! filesink location="${out_file}" -e -t 5
