...
# Stream the specified video for 5 seconds using GStreamer
gst-launch-1.0 filesrc location="${video}" ! decodebin ! videoconvert ! x264enc ! flvmux ! rtmpsink location="rtmp://localhost:1935/live/video.flv" -e -t 5
